...
Shader "Custom/WaterSea"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult84 = lerp( ( ( _ColorVoronoi * pow( voroi1 , _VoronoiPower ) ) + _Color ) , temp_cast_0 , saturate( step( temp_cast_1 , tex2D( _Noise1, (temp_output_63_0*_EdgeNoiseTiling + ( _Time.y * _FoamSpeed )) ) ) ));
...
Node;AmplifyShaderEditor.ColorNode;7;-773.1747,-104.9648;Inherit;False;Property;_ColorVoronoi;ColorVoronoi;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.8537736,0.9556628,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-622.5851,968.8322;Inherit;False;Property;_WaveHeight;WaveHeight;10;0;Create;True;0;0;0;False;0;False;0.0001;0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-1243.434,-1004.782;Inherit;False;Property;_FoamAmount;FoamAmount;14;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;3;-772.5,-294.5;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0.4009434,0.6300666,1,0;0.2901961,0.6509804,0.8862745,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;92;197.6683,-685.0442;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=49313DCD61F4B6BD26F9CCABE31EE07723A734A3